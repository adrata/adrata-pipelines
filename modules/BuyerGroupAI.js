...
Respond in JSON format with your analysis.`;
    ...
    async determineBuyerGroupRoles(contextAnalysis) {
        ...
        const prompt = `Based on this company analysis, determine the optimal buyer group for a B2B sales process:
...
Respond in JSON format with specific, actionable buyer group roles.`;
...
async function main() {
    ...
    if (args.includes('--example')) {
        ...
        console.log('Import and use the BuyerGroupAI class in your applications.');
    }
}
