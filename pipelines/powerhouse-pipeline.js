...
class PowerhousePipeline {
    constructor() {
        ...
        const config = {
            ...
            MAX_PARALLEL_COMPANIES: 15,        // Moderate parallelization for complex powerhouse pipeline
            MAX_PARALLEL_APIS: 8,              // Higher concurrent API calls for comprehensive data
            REDUCED_DELAYS: true,
            CACHE_ENABLED: true,
        ...
        this.buyerGroupAI = new BuyerGroupAI(config);
...
Provide ONLY a JSON response:
{
    ...
    async generateDatasetCSV() {
        ...
        const csvWriter = createObjectCsvWriter({
            ...
            header: [
                ...
                // POWERHOUSE PIPELINE: SBI-ALIGNED BUYER GROUP INTELLIGENCE
                { id: 'economicBuyer', title: 'Economic Buyer' },
                { id: 'economicBuyerTitle', title: 'Economic Buyer Title' },
                { id: 'economicBuyerEmail', title: 'Economic Buyer Email' },
                { id: 'economicBuyerPhone', title: 'Economic Buyer Phone' },
                { id: 'economicBuyerLinkedIn', title: 'Economic Buyer LinkedIn' },
                
                { id: 'champion', title: 'Champion' },
                { id: 'championTitle', title: 'Champion Title' },
                { id: 'championEmail', title: 'Champion Email' },
                { id: 'championPhone', title: 'Champion Phone' },
                { id: 'championLinkedIn', title: 'Champion LinkedIn' },
                
                { id: 'coach', title: 'Coach' },
                { id: 'coachTitle', title: 'Coach Title' },
                { id: 'coachEmail', title: 'Coach Email' },
                { id: 'coachPhone', title: 'Coach Phone' },
                { id: 'coachLinkedIn', title: 'Coach LinkedIn' },
                
                { id: 'technicalInfluencer', title: 'Technical Influencer' },
                { id: 'technicalInfluencerTitle', title: 'Technical Influencer Title' },
                { id: 'technicalInfluencerEmail', title: 'Technical Influencer Email' },
                { id: 'technicalInfluencerPhone', title: 'Technical Influencer Phone' },
                { id: 'technicalInfluencerLinkedIn', title: 'Technical Influencer LinkedIn' },
                
                { id: 'sbiRoutingStrategy', title: 'SBI Routing Strategy' },
                { id: 'primaryEntryPoint', title: 'Primary Entry Point' },
                { id: 'primaryEntryReason', title: 'Primary Entry Reason' },
                { id: 'secondaryEntryPoint', title: 'Secondary Entry Point' },
                { id: 'secondaryEntryReason', title: 'Secondary Entry Reason' },
                { id: 'entrySequence', title: 'Entry Sequence' },
                { id: 'timingRecommendation', title: 'Timing Recommendation' },
                { id: 'sbiApproachStrategy', title: 'SBI Approach Strategy' },
    ...
    async generateDatasetMetrics() {
        const outputDir = path.join(__dirname, '../../outputs/powerhouse');
    ...
    async analyzeBuyerGroup(result) {
        try {
            ...
            return {
                success: false,
                error: error.message,
                companyContext: result?.companyName || 'Unknown'
            };
        }
    }
