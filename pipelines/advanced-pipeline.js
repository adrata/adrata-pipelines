 ...
 * 1. Processes companies from CSV with advanced executive research
 * 2. Adds parent company, merger, and acquisition intelligence
 * 3. Integrates CoreSignal people data (emails, experience, salary)
 * 4. Produces advanced CSV with validated executive intelligence
 * Note: Does NOT include PE/VC firm analysis (use powerhouse-pipeline.js for that)
 */
 ...
 * ADVANCED PIPELINE
 * 
 * Comprehensive executive intelligence with full relationship analysis:
...
class AdvancedPipeline {
    constructor() {
        ...
        const config = {
            ...
            MAX_PARALLEL_COMPANIES: 20,        // High parallelization for advanced pipeline
            MAX_PARALLEL_APIS: 6,              // Concurrent API calls per company
            REDUCED_DELAYS: true,
            CACHE_ENABLED: true,
     ...
     */
    async runPipeline() {
        console.log('ADVANCED PIPELINE');
        console.log('=' .repeat(80));
        console.log('Advanced executive research with finance team analysis');
        ...
        console.log('Parent company, merger, and acquisition research');
     ...
     * Note: PE/VC firms are handled in powerhouse-pipeline.js
     */
    async addRelatedCompanyRows() {
        ...
        for (const result of this.results) {
            // 1. ADD PARENT COMPANIES (includes mergers/acquisitions)
...
Provide ONLY a JSON response:
{
    ...
    async generateDatasetCSV() {
        ...
        const csvWriter = createObjectCsvWriter({
            ...
            header: [
                ...
                // ADVANCED PIPELINE: CORPORATE STRUCTURE INTELLIGENCE
                { id: 'status', title: 'Company Status' },
        ...
        console.log(`    Generated: ${outputDir}/advanced-executive-intelligence-dataset.csv`);

        // Also generate detailed JSON for analysis
        fs.writeFileSync(`${outputDir}/advanced-executive-intelligence-data.json`, JSON.stringify(this.results, null, 2));
        console.log(`    Generated: ${outputDir}/advanced-executive-intelligence-data.json`);
    }
    ...
    async generateDatasetMetrics() {
        ...
        fs.writeFileSync(`${outputDir}/advanced-dataset-metrics.json`, metricsJson);
        console.log(`    Generated: ${outputDir}/advanced-dataset-metrics.json`);

        // Generate human-readable metrics report
        await this.generateMetricsReport(metrics, outputDir);
        console.log(`    Generated: ${outputDir}/advanced-dataset-metrics-report.md`);
    }
     ...
     *  GENERATE HUMAN-READABLE METRICS REPORT
     */
    async generateMetricsReport(metrics, outputDir) {
...
`;
        ...
        fs.writeFileSync(`${outputDir}/advanced-dataset-metrics-report.md`, report);
    }
    ...
    generateSummary() {
        ...
        console.log(`    outputs/${version}/advanced-executive-intelligence-dataset.csv - Main results`);
        console.log(`    outputs/${version}/advanced-executive-intelligence-data.json - Detailed data`);
        console.log(`    outputs/${version}/advanced-dataset-metrics.json - Dataset analytics`);
        console.log(`    outputs/${version}/advanced-dataset-metrics-report.md - Human-readable metrics`);
    }
 ...
 */
async function main() {
    console.log('🚀 Starting Advanced Pipeline...\n');
    ...
    if (result.success) {
        ...
        console.log(' All companies processed with advanced intelligence');
